...
public class Gemstone extends Item {
	...
	public String getUnlocalizedName(ItemStack itemstack) {
		return Names.gemstone_unlocalizedName[itemstack.getItemDamage()];
	}
	...
	public void registerIcons(IconRegister icon) {
		icons = new Icon[Names.gemstone_unlocalizedName.length];

		for(int i = 0; i < icons.length; i++) {
			icons[i] = icon.registerIcon(ModInfo.ID.toLowerCase() + ":" + Names.gemstone_unlocalizedName[i]);
		}
	}
